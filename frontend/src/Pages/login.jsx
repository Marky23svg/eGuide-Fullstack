...
function Login() {
  ...
  const handleSignUp = (e) => {
    e.preventDefault()
    console.log('Sign Up:', { regName, regStudentNo, regEmail, regPassword })
  }
  ...
  const handleForgotEmail = (e) => {
    ...
    setForgotStep('code') // move to next step
  }
  ...
  const handleResetPassword = (e) => {
    ...
    setActiveTab('login') // go back to login after reset
    setForgotStep('email') // reset forgot flow for next time
  }
